		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Children Educational Expenses",
									"targetURL": "#comirdazeducationalexpenses-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comirdazeducationalexpenses-display": {
								"semanticObject": "comirdazeducationalexpenses",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.irda.zeducationalexpenses",
									"url": sap.ui.require.toUrl("com/irda/zeducationalexpenses")
								}
							}
						}
					}
